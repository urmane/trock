...
local ShowLockpick = require_first("mod.dialogs.Lockpick", "engine.dialogs.Lockpick")
...
--- Show lock dialog
-- FIXME @param inven the inventory (from self:getInven())
-- FIXME @param filter nil or a function that filters the objects to list
-- FIXME @param action a function called when an object is selected
function _M:showLockpick(title, filter, action, on_select)
	local d = ShowLockpick.new(title, self, filter, action, on_select)
